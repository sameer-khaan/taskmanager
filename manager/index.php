...
<body class="login">
   ...
   <div class="content">
      ...
      <form id="login" class="login-form" method="post">
          <h1 class="form-title text-center" style="color:gray">Manager Login</h1>
		 ...
		 <div id="account_found">
		 </div>
         <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Password</label>
			<div class="input-icons">
				<input class="form-control placeholder-no-fix customTextBox" type="password"  placeholder="Password" name="password" />
			</div>
         </div>
		 
		  <div class=" form-group text-center">
			 <a href="<?php echo $admin_url?>forgetPassword.php" id="forgot-password-btn">Forgot Password</a>
         </div>
         ...
         <div class="form-group">
		  ...
		  <div class="form-group text-center">
            <button type="submit" class="btn-round btn-info">Enter</button>
         </div>
      </form>
      <!-- END LOGIN FORM -->
   </div>
