				...
				<div class="widget-container margin-top-10">
					<div class="widget-content">
						...
						<p class="text-center mb-lg">
							<strong style="font-size: 26px;">Archived Task List</strong>
						</p>
						<br>
							...
							<table class="table table-bordered bootstrap-datatable datatable dataTable" id="myTable">
								<thead>
									<tr>
										...
										<th style="font-weight:bold;">Assign To</th>
								...
								<tbody>
									<?php
									$sql = "SELECT a.*, b.name as dev_name, c.level as level FROM tasks a, developers b, priority c WHERE a.dev_id = b.id AND a.priority_level = c.value AND a.is_archived = '1' ORDER BY a.archived_date DESC";
									$res = $conn->query($sql);
