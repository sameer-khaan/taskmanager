...
var Charts = function () {
    ...
    return {
        ...
        initPieCharts: function () {
			...
			var series = jsonGraph;

			i=0;
			$.each(series, function(indx,vals) {
				//$.each(vals, function(itemCat,countNum) {
					data[i] = {
						label:  vals.blog_category,
						data: vals.num_users,
					};
					i++;
				//});
...
*/
         ...
         /*   $.plot($("#donut"), data, {
            ...
            $("#pie_chart_7").bind("plothover", pieHover);
            $("#pie_chart_7").bind("plotclick", pieClick);
