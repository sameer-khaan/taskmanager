...
<body class="login">
   ...
   <div class="content">
      ...
      <form id="login" class="login-form" method="post">
          <h1 class="form-title text-center" style="color:gray">Developer Login</h1>
         ...
         <div class="form-group">
		  ...
		  <div class=" form-group text-center">
			 <a href="<?php echo $base_url?>forgetPassword.php" id="forgot-password-btn">Forgot Password</a>
         </div>
